        ...
        {PANEL_TABS.map((tab) => {
          ...
          return (
            <button
              ...
              className={`relative flex min-w-[10.5rem] shrink-0 flex-col items-center justify-center gap-2 rounded-2xl border px-4 py-4 text-center transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:scale-[1.02] active:scale-95 active:duration-75 lg:min-w-0 lg:flex-1 ${
                activeTab === tab.id
